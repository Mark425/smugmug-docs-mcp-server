export interface SmugMugDocEntry {
  id: string;
  title: string;
  summary: string;
  url: string;
...
export const smugMugDocs: SmugMugDocEntry[] = [
  {
    id: "overview",
...
export function searchSmugMugDocs(query: string) {
...
export async function fetchSmugMugDocPage(input: string) {
